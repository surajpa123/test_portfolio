...
const Contact = () => {
    ...
    return <Box w={"100%"} backgroundColor={theme === "dark" ? "black" : "white"} color={theme === "dark" ? "white" : "black"} id="contact">
        ...
        <Text textAlign={"center"} mt={"5px"}>Created & Designed by <a href="https://github.com/Ashishroul" target="_blank" rel="noreferrer noopener" style={{ color: "#4A90E2" }}>Ashish Roul</a></Text>
    </Box >
}
